...
const NewsList = () => {
    ...
    const renderNavbar = () => {
        return (
            <nav className="navbar navbar-expand-lg d-flex justify-content-between flex-nowrap navbar-light bg-info">
                    ...
                    <li key={item.id} style={{ color: item.isRead ? 'grey' : 'inherit' }}>
                        <div className="newsItem">
                            ...
                            <div className="upvotesAndComments">
                                ...
                                <span onClick={() => handleHide(user, item.id, navigate, setNews)}>
                                    Hide
                                </span>
                            </div>
                        </div>
